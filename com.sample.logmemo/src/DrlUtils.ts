...
*/
import { Context, IDartFileSystem, IProgramManager, ModuleContext , SubProgram, MonitoringVariable, logger } from 'dart-api';
...
export default class DrlUtils {
  ...
  public async runProgram(
    ...
    if (subProgramFilePaths.length > 0) {
      ...
      //ryu
      logger.debug(JSON.stringify(subPrograms));
    }
